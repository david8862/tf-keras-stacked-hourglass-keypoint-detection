...
# -*- coding: utf-8 -*-
"""
Script to modify converted Hourglass ONNX model to remove "Transpose" OP
...
def main():
    parser = argparse.ArgumentParser(argument_default=argparse.SUPPRESS, description='edit Hourglass onnx model to delete the Transpose OP at head')
    parser.add_argument('--input_model', help='input Hourglass onnx model file to edit', type=str, required=True)
