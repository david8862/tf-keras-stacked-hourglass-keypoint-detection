...
# -*- coding: utf-8 -*-
"""
Script to convert Stacked Hourglass keras model to ONNX model
"""
...
def main():
    parser = argparse.ArgumentParser(argument_default=argparse.SUPPRESS, description='Convert Stacked Hourglass tf.keras model to ONNX model')
